...
ros::Publisher sonars1("sonars1", &str_msg1);        // Instantiate the publisher with the name sonars

std_msgs::Int8 str_msg2;          
ros::Publisher sonars2("sonars2", &str_msg2);        // Instantiate the publisher with the name sonars

std_msgs::Int8 str_msg3;          
ros::Publisher sonars3("sonars3", &str_msg3);        // Instantiate the publisher with the name sonars

std_msgs::Int8 str_msg4;          
ros::Publisher sonars4("sonars4", &str_msg4);        // Instantiate the publisher with the name sonars

std_msgs::Int8 str_msg5;          
ros::Publisher sonars5("sonars5", &str_msg5);        // Instantiate the publisher with the name sonars


int trigPin1 = BDPIN_GPIO_1;                         // Attaching the Ultrasonic sensor pins to Arduino Pins    
int echoPin1 = BDPIN_GPIO_2;

int trigPin2 = BDPIN_GPIO_3;
int echoPin2 = BDPIN_GPIO_4;

int trigPin3 = BDPIN_GPIO_5;
int echoPin3 = BDPIN_GPIO_6;

int trigPin4 = BDPIN_GPIO_7;
int echoPin4 = BDPIN_GPIO_8;

int trigPin5 = BDPIN_GPIO_9;
int echoPin5 = BDPIN_GPIO_10;


Ultrasonic sonar1(trigPin1, echoPin1);
Ultrasonic sonar2(trigPin2, echoPin2);
Ultrasonic sonar3(trigPin3, echoPin3);
Ultrasonic sonar4(trigPin4, echoPin4);
Ultrasonic sonar5(trigPin5, echoPin5);
...
void setup()
{
  ...
  pinMode(trigPin1,OUTPUT);             // Declare the digital pins as ouputs and inputs respectively
  ...
  nh.advertise(sonars1);               // Declare the topic for sonars1
  nh.advertise(sonars2);
  nh.advertise(sonars3);
  nh.advertise(sonars4);
  nh.advertise(sonars5);
  // added by PT end
...
if ((t-tTime[7]) > 300)
  ...
  distance3 = sonar3.read();
  distance4 = sonar4.read();
  distance5 = sonar5.read();
  ...
  sonars1.publish( &str_msg1 );
  sonars2.publish( &str_msg2 );
  sonars3.publish( &str_msg3 );
  sonars4.publish( &str_msg4 );
  sonars5.publish( &str_msg5 );
    tTime[7] = t;  
  }
  // added by PT end
